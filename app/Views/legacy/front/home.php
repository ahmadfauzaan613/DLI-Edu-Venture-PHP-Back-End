                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form contact-form">
                                    <form action="<?= base_url('home/contact') ?>" method="post" role="form" class="php-email-form">
                                        ...
                                        <?php if ($contactMessage = session('contactMessage')): ?><p class="alert alert-info" role="status"><?= esc($contactMessage) ?></p><?php endif; ?>
                                        <?php foreach ((array) session('contactErrors') as $error): ?><p class="alert alert-danger" role="alert"><?= esc($error) ?></p><?php endforeach; ?>
                                    </form>
                                </div>
                            </div>
                            <!-- End Left contact -->
        ...
        <section id="search" class="search">
            <div class="container">
                    ...
                    <div class="row justify-content-center mt-2">
                        <div class="col-md-6" data-aos="fade-up" data-aos-delay="150">
                            ...
                            <a class="form-inline d-flex justify-content-center md-form form-sm active-cyan active-cyan-2 mt-2 get-started">
                                ...
                                <input name="keyword" class="form-control form-control-sm ml-3 w-75" type="search" value="<?= esc($searchKeyword ?? '') ?>" placeholder="Search" aria-label="Search">
                ...
                <?php if (! empty($searchKeyword)): ?>
                    <div class="search-results mt-4" aria-live="polite">
                        <h3>Hasil untuk “<?= esc($searchKeyword) ?>”</h3>
                        <?php if (empty($searchResults)): ?><p>Tidak ada konten yang cocok.</p><?php else: ?>
                            <ul><?php foreach ($searchResults as $result): ?><li><span class="text-muted"><?= esc($result['type']) ?></span> · <a href="<?= esc($result['url']) ?>"><?= esc($result['title']) ?></a></li><?php endforeach; ?></ul>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
