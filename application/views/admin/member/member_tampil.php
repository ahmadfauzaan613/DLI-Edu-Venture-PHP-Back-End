            ...
            <div class="container">
                ...
                <div class="row content text-justify mb-4">
                            ...
                            <tbody class="text-justify">
                                ...
                                foreach ($produk_data as $member):
                                  ...
                                  <tr>
                                    ...
                                    <td> 
                                        <img src="<?php echo base_url('assets/images/member/'.$member->foto.'_thumb'.$member->foto_type)?>" width="150" height="110" />
                                    </td>
                                    <td> <?php echo $member->created;?> </td>
                                    <td>
                                        <a href=" <?php echo base_url('admin/member/delete/'.$member->id) ?> " class="btn btn-content-delete mb-2">
                    ...
                    <div class="row content text-center">
                        <div class="col" data-aos="fade-up" data-aos-delay="150">
                            <a href=" <?php echo base_url("admin/member/create");?> " class="btn btn-content-add mb-2">
