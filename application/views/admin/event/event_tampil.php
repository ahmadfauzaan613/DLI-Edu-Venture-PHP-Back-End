            ...
            <div class="container">
                ...
                <div class="row content text-justify mb-2">
                            ...
                            <tbody class="text-justify">
                                ...
                                foreach ($produk_data as $event):
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo base_url('assets/images/event/'.$event->foto.'_thumb'.$event->foto_type)?>" width="150" height="110" />
                                    </td>
                                    ...
                                    <td><?php echo $event->jadwal_time ?> WIB </td>

                                    <td>
                                        <?php echo $event->created ?>        
                                    </td>
                                    <td>
                                        <?php echo $event->modified ?>
                                    </td>
                                    <td>
                                        <a href="<?php echo base_url('admin/event/update/'.$event->id_event)?>" class="btn btn-content-update mb-2">
                                            <i class="fa fa-pencil-square-o prefix grey-text"></i> Update
                                        </a>
                                        <a href=" <?php echo base_url('admin/event/delete/'.$event->id_event) ?> " class="btn btn-content-delete mb-2">
                    ...
                    <div class="row content text-center">
                        <div class="col" data-aos="fade-up" data-aos-delay="150">
                            <a href="<?php echo site_url('admin/event/create') ?>" class="btn btn-content-add mb-2">
                                <i class="fa fa-user-plus prefix grey-text"></i> Add events
                            </a>
                        </div>
                    </div>
                </div>
...
<!-- ======= Modal Delete events Section ======= -->
<div class="modal fade mt-4 pt-4" id="modalDeleteeventsForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content border border-danger">
            <div class="modal-header text-center bg-danger text-white">
                <h4 class="modal-title w-100 font-weight-bold">Delete events</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <!-- End Modal Delete events Section -->