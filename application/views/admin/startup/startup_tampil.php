                    ...
                    <div class="col-8 mb-2 mb-md-0" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <table class="table table-striped table-bordered table-hover table-responsive text-nowrap">
                            ...
                            <tbody class="text-justify">
                                ...
                                <?php $no=1; 
                                foreach ($produk_data as $startup):
                                  ?>
                                  ...
                                  <tr>
                                    ...
                                    <td><?php echo $startup->judul_startup ?></td>
                                    <td>
                                        <?php 
                                        $dikit=$startup->isi;
                                    ...
                                    <td>
                                        <img src="<?php echo base_url('assets/images/startup/'.$startup->foto.'_thumb'.$startup->foto_type)?>" width="150" height="110" />
                                        
                                        <td>
                                            <?php 
                                            $dikit=$startup->spesifikasi;
                                            $potong=substr($dikit,0, 30);
                                            echo $potong;
                                            ?> ... ... ...
                                        </td>
                                        ...
                                        <td>
                                            <?php 
                                            $dikit=$startup->pencapaian;
                                            $potong=substr($dikit,0, 30);
                                            echo $potong;
                                            ?> ... ... ...
                                        </td>
                                        
                                        <td><?php echo $startup->kategori ?></td>
                                        
                                        <td><?php echo $startup->teknologi ?></td>
                                        
                                        <td><?php echo $startup->web ?></td>
                                        
                                        <td><?php echo $startup->fb ?></td>
                                        
                                        <td><?php echo $startup->ig ?></td>
                                        
                                        <td>
                                            <?php echo $startup->created ?>        
                                        </td>
                                        <td>
                                            <?php echo $startup->modified ?>
                                        </td>
                                        <td>
                                            <a href="<?php echo base_url('admin/startup/update/'.$startup->id_startup)?>" class="btn btn-content-update mb-2">
                                                <i class="fa fa-pencil-square-o prefix grey-text"></i> Update
                                            </a>
                                            <a href=" <?php echo base_url('admin/startup/delete/'.$startup->id_startup) ?> " class="btn btn-content-delete mb-2">
                        ...
                        <div class="row content text-center">
                            <div class="col" data-aos="fade-up" data-aos-delay="150">
                                <a href="<?php echo site_url('admin/startup/create') ?>" class="btn btn-content-add mb-2">
                                    <i class="fa fa-user-plus prefix grey-text"></i> Add startups
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    <!-- ======= Modal Delete startups Section ======= -->
    <div class="modal fade mt-4 pt-4" id="modalDeletestartupsForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content border border-danger">
                <div class="modal-header text-center bg-danger text-white">
                    <h4 class="modal-title w-100 font-weight-bold">Delete startups</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <!-- End Modal Delete startups Section -->