            ...
            <div class="container">
                ...
                <div class="row content text-justify mb-2">
                            ...
                            <tbody class="text-justify">
                                ...
                                foreach ($produk_data as $news):
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo base_url('assets/images/news/'.$news->foto.'_thumb'.$news->foto_type)?>" width="150" height="110" />
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('admin/news/update/'.$news->id_news)?>" class="btn btn-content-update mb-2">
                                            <i class="fa fa-pencil-square-o prefix grey-text"></i> Update
                                        </a>
                                        <a href=" <?php echo base_url('admin/news/delete/'.$news->id_news) ?> " class="btn btn-content-delete mb-2">
                    ...
                    <div class="row content text-center">
                        <div class="col" data-aos="fade-up" data-aos-delay="150">
                            <a href="<?php echo site_url('admin/news/create') ?>" class="btn btn-content-add mb-2">
                                <i class="fa fa-user-plus prefix grey-text"></i> Add newss
                            </a>
                        </div>
                    </div>
                </div>
...
<!-- ======= Modal Delete newss Section ======= -->
<div class="modal fade mt-4 pt-4" id="modalDeletenewssForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content border border-danger">
            <div class="modal-header text-center bg-danger text-white">
                <h4 class="modal-title w-100 font-weight-bold">Delete newss</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <!-- End Modal Delete newss Section -->