		...
		<div class="container d-flex align-items-center">
			...
			<nav class="nav-menu d-none d-lg-block">
				<ul>
					...
					<li class="drop-down active"><a href="#">Admin</a>
						<ul>
							<li>
								<a href=" <?php echo base_url("admin/login") ?> " class="btn btn-modal mb-2">
					...
					<div class="col-md-6 mt-2" data-aos="fade-up" data-aos-delay="200">
						...
						<form action="<?php echo base_url('admin/login/aksi_login'); ?>" method="post">		
							...
							<div class="form-group">
								...
								<input type="text" name="email" class="form-control" id="inputUsername" placeholder="Admin Username" required>

							</div>
							<div class="form-group">
								<i class="fa fa-lock prefix grey-text"></i>
								<label for="inputPassword"> | Password</label>
								<input type="password" name="password" class="form-control" id="inputPassword" placeholder="Admin Password" required>
							</div>
