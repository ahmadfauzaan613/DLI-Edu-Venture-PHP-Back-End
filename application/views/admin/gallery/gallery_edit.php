                <div class="row content text-justify mb-2">
                  ...
                  <div class="col-8 mb-2 mb-md-0" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="form-group">
                      ...
                      <?php echo form_input($judul_gallery, $produk->judul_gallery);?>
                    </div>
                    
                    <div class="form-group"><label>Gambar Sebelumnya</label><br>
                      <img src="<?php echo base_url('assets/images/gallery/'.$produk->foto.$produk->foto_type.'') ?>" width="200px"/>
                    </div>
                    <div class="form-group"><label>Gambar</label>
                      ...
                      <?php echo form_input($id_gallery,$produk->id_gallery);?>
                      <hr>
