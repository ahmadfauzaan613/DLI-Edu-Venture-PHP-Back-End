            ...
            <div class="container">
                ...
                <div class="row content text-justify mb-2">
                    ...
                    <div class="col-8 mb-2 mb-md-0" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <table class="table table-striped table-bordered table-hover table-responsive text-nowrap">
                            ...
                            <tbody class="text-justify">
                                ...
                                <?php $no=1; 
                                foreach ($produk_data as $gallery):
                                  ?>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo base_url('assets/images/gallery/'.$gallery->foto.'_thumb'.$gallery->foto_type)?>" width="150" height="110" />
                                    </td>
                                    <td>
                                        <?php echo $gallery->created ?>        
                                    </td>
                                    <td>
                                        <?php echo $gallery->modified ?>
                                    </td>
                                    <td>
                                        <a href="<?php echo base_url('admin/gallery/update/'.$gallery->id_gallery)?>" class="btn btn-content-update mb-2">
                                            <i class="fa fa-pencil-square-o prefix grey-text"></i> Update
                                        </a>
                                        <a href=" <?php echo base_url('admin/gallery/delete/'.$gallery->id_gallery) ?> " class="btn btn-content-delete mb-2">
                    ...
                    <div class="row content text-center">
                        <div class="col" data-aos="fade-up" data-aos-delay="150">
                            <a href="<?php echo site_url('admin/gallery/create') ?>" class="btn btn-content-add mb-2">
                                <i class="fa fa-user-plus prefix grey-text"></i> Add <?php echo $titleAll;?>
                            </a>
                        </div>
                    </div>
                </div>
...
<!-- ======= Modal Delete gallerys Section ======= -->
<div class="modal fade mt-4 pt-4" id="modalDeletegallerysForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content border border-danger">
            <div class="modal-header text-center bg-danger text-white">
                <h4 class="modal-title w-100 font-weight-bold">
                    Delete <?php echo $titleAll;?> 
                </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
    ...
    <!-- End Modal Delete gallerys Section -->