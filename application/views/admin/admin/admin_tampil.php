            ...
            <div class="container">
                ...
                <div class="row content text-justify mb-4">
                            ...
                            <tbody class="text-justify">
                                ...
                                foreach ($produk_data as $admin):
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <a href=" <?php echo base_url('admin/admin/delete/'.$admin->id) ?> " class="btn btn-content-delete mb-2">
                    ...
                    <div class="row content text-center">
                        <div class="col" data-aos="fade-up" data-aos-delay="150">
                            <a href=" <?php echo base_url("admin/admin/create");?> " class="btn btn-content-add mb-2">
                                <i class="fa fa-user-plus prefix grey-text"></i> Add Admin
                            </a>
                        </div>
                    </div>
                </div>
