            ...
            <div class="container">
                ...
                <div class="row content text-justify justify-content-center mb-2">
                    <div class="col-md-6 mb-2" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <?php echo form_open("user/email_reset_password_validation") ?>
                            ...
                            <div class="text-center">
                                <button type="reset" class="btn btn-danger btn-form rounded-pill">Clear</button>
                                <input type="submit" class="btn btn-info btn-form rounded-pill" value="submit">
                            </div>
                        <?php echo form_close() ?>
                        <!-- </form> -->
                        <hr>
