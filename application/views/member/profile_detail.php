                        ...
                        <?php foreach ($profil as $profil1): ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row ml-1">
                                    ...
                                    <img src="<?php echo base_url('assets/images/member/'.$profil1->foto.'_thumb'.$profil1->foto_type)?>" class="img-thumbnail rounded" width="40%" />
