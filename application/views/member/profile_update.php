                ...
                <div class="row content text-justify mb-2">
                    ...
                    <div class="col-8 mb-2 mb-md-0" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo form_input($name, $produk->name);?>
                        </div>
                        <div class="form-group">
                            <i class="fa fa-envelope prefix grey-text"></i>
                            <label for="inputEmail"> | Email Address</label>
                            <?php echo form_input($email, $produk->email);?>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <?php echo form_input($password, $produk->password);?>
                            </div>
                        </div>
                        <div class="form-group">
                            <i class="fa fa-phone prefix grey-text"></i>
                            <label for="inputPhone"> | Phone Number</label>
                            <?php echo form_input($phone, $produk->phone);?>
                        </div>
                        <div class="form-group">
                            <i class="fa fa-map-marker prefix grey-text"></i>
                            <label for="inputAddress"> | Address</label>
                            <?php echo form_input($address, $produk->address);?>
                        </div>
                        <div class="form-group">
                            <i class="fa fa-user-circle prefix grey-text"></i>
                            <label for="inputBio"> | Bio</label>
                            <?php echo form_input($bio, $produk->bio);?>
                        ...
                        <div class="form-group">
                            ...
                            <img src="<?php echo base_url('assets/images/member/'.$produk->foto.$produk->foto_type.'') ?>" width="200px"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="text-center">
                                ...
                                <button type="submit" class="btn btn-info btn-form rounded-pill">Update</button>
                            </div>
